...
public class Eliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("            Eliminar tareas");
    ...
    public void mostrarTabla() {
        tabla.setModel(metodos.listaTareas());
    }
    
    private void eliminarTarea() {
        int filaSeleccionada = tabla.getSelectedRow();
        if (filaSeleccionada != -1) {
            int dialogResult = JOptionPane.showConfirmDialog(null, "¿Está seguro que quiere borrar esta tarea?", "Advertencia", JOptionPane.YES_NO_OPTION);
        }
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        metodos.eliminarTarea(eliminar);
        mostrarTabla();
